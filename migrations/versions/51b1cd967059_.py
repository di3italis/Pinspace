...
Revision ID: 51b1cd967059
Revises:
Create Date: 2024-07-22 18:49:43.688393
...
def upgrade():
    ...
    op.create_table('boards',
        ...
        sa.ForeignKeyConstraint(['ownerId'], [f"{SCHEMA}.users.id"] if environment == "production" else ['users.id']),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('boardPins',
        ...
        sa.ForeignKeyConstraint(['boardId'], [f"{SCHEMA}.boards.id"] if environment == "production" else ['boards.id']),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('comments',
        ...
        sa.ForeignKeyConstraint(['pinId'], [f"{SCHEMA}.pins.id"] if environment == "production" else ['pins.id']),
        sa.PrimaryKeyConstraint('id')
    )
